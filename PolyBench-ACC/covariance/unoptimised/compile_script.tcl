...
create_kernel mean_kernel -type "clc"
add_files -kernel [ get_kernels mean_kernel ] covariance.cl

create_kernel reduce_kernel -type "clc"
add_files -kernel [ get_kernels reduce_kernel ] covariance.cl
...
create_compute_unit -opencl_binary [get_opencl_binary covariance_bin] -kernel [get_kernels mean_kernel]     -name cu_mean
create_compute_unit -opencl_binary [get_opencl_binary covariance_bin] -kernel [get_kernels reduce_kernel]   -name cu_reduce
